...
A quick start Angular project that shows how to add connectors in an [Angular Diagram](https://www.syncfusion.com/diagram-sdk/angular-diagram). This project includes a code snippet to add a connector programmatically and using the drawing tool. It also includes a code snippet to add different types of connector segments and decorator shapes.
